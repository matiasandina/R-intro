...
```{r tabla_convenciones, echo=F, warning=F}

conv_df <- read.csv(file = 'data/tabla_convenciones.csv')
conv_df <- dplyr::arrange(conv_df, term) 


knitr::kable(conv_df, 
             col.names = c("Término en inglés", "Descripción"))
...
message("Error: error message here")
